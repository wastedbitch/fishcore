      ...
      <div className="">
        ...
        <nav className="hidden h-[100vh] w-24 lg:flex items-center justify-end my-auto">
          <div className="bg rounded-lg border-[#62102f] border flex flex-col w-20 gap-4 items-center py-2">
              ...
              <div className="text-center text-neutral-600 opacity-50"><Link href="/"><Image src="/icons/gallery.ico" width="64" height="64" alt="Files" className="mb-0.5"></Image>Gallery</Link></div>
              ...
              <div className="text-center text-neutral-600 opacity-50"><Link href="/"><Image src="/icons/music.ico" width="64" height="64" alt="Music" className="mb-0.5"></Image>Music</Link></div>
        ...
        <nav className="lg:hidden w-full h-24 flex items-center justify-center my-auto">
          <div className="bg rounded-lg border-[#62102f] border flex flex-row h-16 gap-4 items-center py-2 mx-4">
              ...
              <div className="opacity-50"><Link href="/"><Image src="/icons/gallery.ico"  width="64" height="64" alt="Files"></Image></Link></div>
              <div className="opacity-50"><Link href="/"><Image src="/icons/music.ico"  width="64" height="64" alt="music"></Image></Link></div>
