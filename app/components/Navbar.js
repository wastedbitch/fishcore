      ...
      <div className="">
        ...
        <nav className="hidden h-[100vh] w-24 lg:flex items-center justify-end my-auto">
          <div className="bg rounded-lg border-[#62102f] border flex flex-col w-20 gap-4 items-center py-2">
              ...
              {/* <div className="text-center hover:text-[#8b1547] hover:underline"><Link href="/fishcore"><Image src="/icons/steam.ico" width="64" height="64" alt="Steam" className="mb-0.5"></Image>Games</Link></div> */}
        ...
        {/* Mobile */}
        <nav className="lg:hidden w-full h-24 flex items-center justify-end my-auto">
          <div className="flex flex-row h-16 gap-4 items-center py-2 mx-4">
              ...
              {/* <div className=""><Link href="/fishcore"><Image src="/icons/steam.ico"  width="64" height="64" alt="mail"></Image></Link></div> */}
