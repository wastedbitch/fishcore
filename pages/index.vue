<template>
    <div class="flex flex-col gap-12 justify-center items-center h-full">
        <audio src="music.mp3" id="fishcore"></audio>
        <img src="/fish.gif" alt="" class="h-[6rem]" if="fish">
...
export default {
  methods: {
    playAudio() {
        ...
        var audio = document.getElementById("fishcore");
        if (audio.paused) {
            audio.play();
        } else {
            none
